...
agent_communication:
  ...
  - agent: "testing"
    message: "He probado la funcionalidad de registro de usuarios y funciona correctamente. Los usuarios pueden registrarse como peregrinos proporcionando nombre, email, contraseña y opcionalmente un ID de grupo. El sistema maneja correctamente los errores como intentar registrar un email ya existente. Después del registro exitoso, los usuarios pueden iniciar sesión con sus nuevas credenciales y acceder al dashboard."