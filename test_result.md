...
agent_communication:
  ...
  - agent: "main"
    message: "SOLUCIONANDO ERROR 'Objects are not valid as a React child': 1) Arreglado handleAPIError en api.js para manejar correctamente errores 422 de validación de Pydantic - ahora extrae mensajes de error en lugar de renderizar objetos; 2) Agregado group_id requerido en EditItineraryModal.js con selector de grupo; 3) Mejorado manejo de errores en el modal con visualización de mensajes específicos; 4) Importado handleAPIError en el modal para mostrar errores legibles."
  - agent: "testing"
